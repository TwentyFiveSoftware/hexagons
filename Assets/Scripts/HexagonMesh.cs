...
public static class HexagonMesh {
    ...
    public static Mesh GenerateHexagonMesh(float height) {
        ...
        for (int degree = 0; degree < 360; degree += 60) {
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * degree), height, Mathf.Sin(Mathf.Deg2Rad * degree)));
        }
        ...
        for (int degree = 0; degree < 360; degree += 60) {
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * degree), 0.0f, Mathf.Sin(Mathf.Deg2Rad * degree)));
        }
        ...
        for (int degree = 30; degree <= 360; degree += 60) {
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * (degree - 30)), height,
                Mathf.Sin(Mathf.Deg2Rad * (degree - 30))));
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * (degree + 30)), height,
                Mathf.Sin(Mathf.Deg2Rad * (degree + 30))));
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * (degree + 30)), 0.0f,
                Mathf.Sin(Mathf.Deg2Rad * (degree + 30))));
            vertices.Add(new Vector3(Mathf.Cos(Mathf.Deg2Rad * (degree - 30)), 0.0f,
                Mathf.Sin(Mathf.Deg2Rad * (degree - 30))));
        }
        ...
        //
        return new Mesh { vertices = vertices.ToArray(), triangles = triangles.ToArray(), normals = normals.ToArray() };
    }
